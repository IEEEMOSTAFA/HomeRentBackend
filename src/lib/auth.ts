...
export const auth = betterAuth({
  // ✅ Render deploy URL — backend এর নিজের URL
  baseURL: process.env.BETTER_AUTH_URL || "https://homerentbackend.onrender.com",

  database: prismaAdapter(prisma, {
    provider: "postgresql",
  }),

  // ✅ Frontend এর সব URL trusted হিসেবে দাও
  trustedOrigins: [
    "http://localhost:3000",
    "http://localhost:3001",
    process.env.APP_URL!,           // Vercel frontend URL
    process.env.FRONTEND_URL!,      // alternate env name
  ].filter(Boolean),
